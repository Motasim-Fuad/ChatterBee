...
class AppTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'pro_feature_1': 'Real-Time Notifications',
      ...
      'speech_mode_immediate': 'Speak Words Immediately',
      'speech_mode_build': 'Build Then Speak',
      'speech_mode_immediate_only': 'Speak Immediately Only',
      'pro_annual_includes': 'Includes all ChatterBee Pro features.',
      'all_categories': 'All Categories',
      'add_to_quick_speak': 'Add from Tap to Talk',
      'swap_quick_speak': 'Replace with an existing button',
      'icon_library': 'Icon library',
      'upload_custom_image': 'Upload custom image (Pro)',
      'good_job': 'Good job!',
      'buddy_bee_encouragement_msg': 'Keep going — you are doing great.',
    ...
    'ar_SA': {
      ...
      'pro_feature_1': 'إشعارات فورية',
      'pro_feature_2': 'حسابات مقدمي رعاية مرتبطة',
      'pro_feature_3': 'تشجيع BuddyBee',
      'pro_feature_4': 'روتينات بصرية',
      'pro_feature_5': 'تخصيص متقدم',
      ...
      'speak': 'تحدث',
      'search_symbols': 'البحث عن الرموز',
      'tap_to_type': 'اضغط للكتابة',
      'type_to_speak_hint': 'اكتب كلمة أو جملة',
      'add': 'إضافة',
      'speech_mode': 'وضع الكلام',
      'speech_mode_immediate': 'التحدث فورًا',
      'speech_mode_build': 'ابنِ ثم تحدث',
      'speech_mode_immediate_only': 'التحدث فورًا فقط',
      'good_job': 'أحسنت!',
      'buddy_bee_encouragement_msg': 'استمر — أنت تبلي بلاءً حسنًا.',
    ...
    'es_ES': {
      ...
      'pro_feature_1': 'Notificaciones en tiempo real',
      'pro_feature_2': 'Cuentas de cuidadores vinculadas',
      'pro_feature_3': 'Motivación BuddyBee',
      'pro_feature_4': 'Rutinas visuales',
      'pro_feature_5': 'Personalización avanzada',
      ...
      'type_to_speak_hint': 'Escribe una palabra o frase',
      'add': 'Agregar',
      'speech_mode': 'Modo de habla',
      'speech_mode_immediate': 'Hablar de inmediato',
      'speech_mode_build': 'Construir y luego hablar',
      'speech_mode_immediate_only': 'Hablar de inmediato solamente',
      'good_job': '¡Buen trabajo!',
      'buddy_bee_encouragement_msg': 'Sigue así — lo estás haciendo genial.',
